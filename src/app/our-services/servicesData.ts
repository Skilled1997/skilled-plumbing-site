...
export const serviceCategories: ServiceCategory[] = [
  ...
  },
  {
    ...
    whyUs:
      "From pre-lays and trenched drain installation on a new build through to scheduled backflow testing and ongoing maintenance, Skilled Plumbing Services works across the full lifecycle of a commercial project. Ren has hands-on experience operating excavators and machinery on site, and has been involved in the plumbing construction of high-rise apartment buildings, cafes, bars, butchers, science labs, hospitals and shopping centres — so builders can bring us in from the ground up, not just for the finishing trades. Businesses also get minimal disruption to daily operations and the compliance paperwork required for backflow and fire service testing.",
